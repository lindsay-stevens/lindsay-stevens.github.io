...
- Health research data and project management.

Examples of how these skills were applied are provided in the following sections.


## Software Application Development
An overview of my skills and experience in this area is below, followed by descriptions of some example projects.
...
### Community DataMart
A reporting tool implemented PostgreSQL using SQL, PL/PGSQL, and Python. Study definition metadata is read from an OpenClinica database and used to prepare tabulated data in a user-friendly format. 
...
- Research study data systems used:
    - OpenClinica: a web based tool for managing data collection and cleaning.
...
- Research study coordination:
    - Australia-wide and international projects collaborating with hospitals and clinics,
    - ICH GCP compliance, including ethics and regulatory applications and reporting,
